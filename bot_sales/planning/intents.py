...
class IntentClassifier:
    ...
    def extract_entities(self, user_message: str) -> dict[str, str | bool | None]:
        ...
        product_family = _first_match(
            msg,
            {
                # Ferretería categories (primary)
                "taladro": "Herramientas Eléctricas",
                "amoladora": "Herramientas Eléctricas",
                "atornillador": "Herramientas Eléctricas",
                "sierra caladora": "Herramientas Eléctricas",
                "lijadora": "Herramientas Eléctricas",
                ...
                "hoja de sierra": "Discos y Hojas",
                "lija": "Lijas y Abrasivos",
                "papel lija": "Lijas y Abrasivos",
                ...
                "casco": "Seguridad",
                "seguridad": "Seguridad",
                # Generic multi-industry (kept as fallback)
                "celular": "Smartphones",
