...
class SlackAppHome:
    ...
    def _get_recent_events(self, limit: int = 5) -> List[Dict]:
        ...
        return [
            {
                'emoji': '✅',
                'description': 'Juan completó compra de Llave Allen Bondhus',
                'time_ago': '5 min'
            },
            {
                'emoji': '💰',
                'description': 'María pidió descuento en Taladro Makita',
                'time_ago': '12 min'
            },
            {
                'emoji': '🛒',
                'description': 'Carlos agregó Tarugos Fischer al carrito',
                'time_ago': '18 min'
            }
        ]
