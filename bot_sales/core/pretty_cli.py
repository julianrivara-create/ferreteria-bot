...
def demo_pretty_cli():
    ...
    # Demo table
    products = [
        {'sku': 'PRD-001', 'model': 'Producto Demo A', 'price_ars': 1200000, 'stock_qty': 5, 'category': 'Categoria A'},
        {'sku': 'PRD-002', 'model': 'Producto Demo B', 'price_ars': 1400000, 'stock_qty': 2, 'category': 'Categoria A'},
        {'sku': 'PRD-003', 'model': 'Producto Demo C', 'price_ars': 1800000, 'stock_qty': 0, 'category': 'Categoria B'},
    ]
