...
class TestE2EFlow:
    ...
    def test_complete_purchase_flow(self, setup):
        ...
        # 1. Search products
        search_result = bl.buscar_stock("Taladro Percutor 13mm")
    ...
    def test_cart_to_checkout(self):
        ...
        # Add multiple items
        cart.add_item("IP15-128-BLK", "Taladro Percutor 13mm 128GB", 1200000, quantity=1)
        cart.add_item("AIRP-PRO2", "Destornillador Pro 2", 450000, quantity=2)
