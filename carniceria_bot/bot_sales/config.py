...
class Config:
    ...
    META_VERIFY_TOKEN = os.getenv('META_VERIFY_TOKEN', 'my_verify_token')
    
    # Instagram
    INSTAGRAM_ACCESS_TOKEN = os.getenv('INSTAGRAM_ACCESS_TOKEN', '')
    INSTAGRAM_VERIFY_TOKEN = os.getenv('INSTAGRAM_VERIFY_TOKEN', 'instagram_verify_token_123')
    ...
    MERCADOPAGO_WEBHOOK_SECRET = os.getenv('MERCADOPAGO_WEBHOOK_SECRET', 'MOCK_SECRET')
    MP_MOCK_MODE = not MERCADOPAGO_ACCESS_TOKEN
    
    # Database (Default)
    DATABASE_PATH = os.getenv('DATABASE_PATH', 'data/iphone_store.db')
    ...
    STORE_NAME = os.getenv('STORE_NAME', 'TechStore')
    STORE_TYPE = os.getenv('STORE_TYPE', 'tecnología')
