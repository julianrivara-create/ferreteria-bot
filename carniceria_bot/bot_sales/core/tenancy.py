...
class TenantManager:
    ...
    def get_bot(self, tenant_id: str) -> Any:
        ...
        gemini_key = tenant.get_api_key("gemini")
        ...
        if gemini_key and not openai_key:
            from ..bot_gemini import SalesBotGemini
            ...
            logger.info("Initialized SalesBotGemini for tenant %s", tenant_id)
        else:
            ...
            logger.info("Initialized SalesBot (OpenAI) for tenant %s", tenant_id)
