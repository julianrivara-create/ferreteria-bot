...
class UniversalLLMClient:
    ...
    def _mock_response(self, messages: List[Dict[str, str]]) -> Dict[str, Any]:
        ...
        elif any(word in user_msg_lower for word in ['iphone', 'celular', 'teléfono']):
            content = "Tenemos stock de iPhone. Como estoy en mantenimiento, te sugiero pedir hablar con un asesor para confirmar detalles exactos."
