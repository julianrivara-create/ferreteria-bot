...
analytics.track_product_query("test_1", "IP16P-256-BLK", "iPhone")
analytics.track_sale("test_1", "IP16P-256-BLK", 2000000, "iPhone")
analytics.track_cross_sell_offer("test_1", "AP-PRO2", "AirPods")
...
analytics.track_product_query("test_2", "IP15PM-512-NAT", "iPhone")
analytics.track_sale("test_2", "IP15PM-512-NAT", 2200000, "iPhone")
analytics.track_cross_sell_offer("test_2", "AP-PRO2", "AirPods")
...
analytics.track_product_query("test_4", "MBA-M3-256-SG", "MacBook")
