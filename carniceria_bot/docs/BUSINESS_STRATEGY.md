...
*   **Situación actual:** El bot usa 1 base de datos (`iphone_store.db`) y 1 archivo de configuración.
...
1.  **White-Labeling**: Sacar "iPhone" y "Sales Bot" del código visible. Que sea 100% configurable por `.env`.
