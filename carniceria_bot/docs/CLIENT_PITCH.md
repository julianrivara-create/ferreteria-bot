...
No es un simple "chatbot" de respuestas automáticas. Es un **Agente de Ventas con Inteligencia Artificial** (potenciado por ChatGPT-4) diseñado específicamente para vender productos High-Ticket (iPhone, Mac, etc.).
...
1.  **Saludo y Detección**: El cliente dice "Hola, precio del iPhone 15". El bot detecta la intención de compra inmediatamente.
2.  **Consulta de Stock Real**: El bot consulta la base de datos en tiempo real.
    *   *Si hay*: "Tengo el iPhone 15 de 128GB en Negro a $1.200 USD. ¿Te interesa ese color?"
    *   *Si no hay*: Le ofrece alternativas (ej: iPhone 14 Pro) automáticamente.
3.  **Manejo de Objeciones**:
    *   Cliente: "Es muy caro".
    *   Bot: "Entiendo, es una inversión. Pero pensá que el iPhone 15 tiene el nuevo chip A16 y cámara de 48MP que te dura 5 años. Además, el valor de reventa es altísimo." (Argumentos de venta reales).
4.  **Cierre y Reserva**:
...
5.  **Cross-Selling Inteligente**:
    *   Bot: "Por cierto, para proteger ese iPhone, ¿querés agregar una funda MagSafe o AirPods con 10% de descuento?"
...
Si el cliente pregunta algo muy raro o se enoja ("Quiero hablar con la dueña"), el bot detecta el sentimiento negativo y hace un **"Handover"**:
...
**(Q) ¿Sirve solo para iPhone?**
**R:** Hoy está configurado para iPhone/Apple, pero la arquitectura sirve para cualquier producto. Solo cambiamos el catálogo.
