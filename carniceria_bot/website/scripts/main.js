    ...
    <div class="product-card" onclick="navigateToProduct('${escapeForAttr(item.model)}')" style="cursor: pointer;">
        <div class="product-image">
            <img src="${imgSrc}"
                 ...
                 onerror="this.onerror=null; this.src='images/iphone15pro.png'">
        </div>
...
function getProductImage(item) {
    ...
    if (category.includes('iphone') || category.includes('smartphone')) {
        if (color.includes('blue')) return 'images/iphone-blue.png';
        if (color.includes('pink')) return 'images/iphone-pink.png';
        if (color.includes('black') || color.includes('negro')) return 'images/iphone-white.png';
