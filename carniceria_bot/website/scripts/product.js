...
function renderProduct() {
    ...
    container.innerHTML = `
        <div class="product-image-section">
            <img src="${getProductImage(productData)}" alt="${productData.model}" class="product-main-image">
        </div>
...
function getProductImage(product) {
    ...
    if (category.includes('smartphone') || category.includes('iphone')) return 'images/iphone15pro.png';
    if (category.includes('laptop') || category.includes('macbook')) return 'images/macbook-space-black.png';
