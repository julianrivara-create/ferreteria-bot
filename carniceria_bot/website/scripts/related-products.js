...
class RelatedProducts {
    ...
    renderCard(product) {
        ...
        return `
            <div class="related-product-card" onclick="navigateToProduct('${product.model}')">
                <img src="${img}" alt="${product.model}" onerror="this.src='images/iphone15pro.png'">
                <h4>${product.model}</h4>
    ...
    getProductThumbnail(product) {
        ...
        if (category.includes('iphone') || category.includes('smartphone')) return `images/iphone-${color}.png`;
        if (category.includes('macbook') || category.includes('laptop')) return `images/macbook-${color}.png`;
