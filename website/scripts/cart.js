...
function resolveTenantSlug() {
    ...
    return window.__TENANT_SLUG || 'default';
}

// Cart Manager
class CartManager {
    constructor() {
        this.tenant = resolveTenantSlug();
        this.storageKey = `salesbot_cart_${this.tenant}`;
        this.legacyStorageKey = 'ateliertechnology_cart';
    ...
    loadCart() {
        try {
            ...
            // Backward compatibility: migrate legacy cart key once.
    ...
    initiateCheckout() {
        ...
        window.location.href = `checkout.html?tenant=${encodeURIComponent(this.tenant)}`;
    }
}
