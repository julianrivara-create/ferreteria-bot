        ...
        const searchHTML = `
            <div class="search-container">
                <input 
                    ...
                    class="search-bar" 
                    id="global-search"
                    placeholder="Buscar por nombre, categoría, color o talle..."
                    autocomplete="off"
                >
        ...
        this.resultsContainer.innerHTML = results.map(product => {
            ...
            return `
                <div class="search-result-item" onclick="navigateToProduct('${product.model}')">
                    <img src="${img}" alt="${product.model}" class="search-result-img" onerror="this.onerror=null; this.src='images/product-placeholder.svg'">
