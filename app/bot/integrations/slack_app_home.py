...
class SlackAppHome:
    ...
    def _get_recent_events(self, limit: int = 5) -> List[Dict]:
        ...
        return [
            {
                'emoji': '✅',
                'description': 'Juan completó compra de Taladro Percutor 13mm',
                'time_ago': '5 min'
            },
            {
                'emoji': '💰',
                'description': 'María consultó precio de Amoladora 115mm',
                'time_ago': '12 min'
            },
            {
                'emoji': '🛒',
                'description': 'Carlos agregó tornillos al carrito',
                'time_ago': '18 min'
            }
        ]
