...
def show_progress_bar(items: List[Any], description: str = "Procesando...") -> List:
    ...
    with Progress(
        ...
        for item in items:
            # Simulate processing
            # time.sleep(0.05)  # Removed for performance
            results.append(item)
...
def demo_pretty_cli():
    ...
    # Demo table
    products = [
        {'sku': 'BF200SGS10', 'model': 'Tarugo Comun 10 x1 - Fischer', 'price_ars': 850, 'stock_qty': 500, 'category': 'Tarugos y Tacos'},
        {'sku': 'BLT10937', 'model': 'Set Llave Allen 050-3/8 BL x 13 - Bondhus', 'price_ars': 45000, 'stock_qty': 8, 'category': 'Llaves'},
        {'sku': 'BF162HR2810', 'model': 'Rotomartillo Makita HR2810 28mm 800W', 'price_ars': 280000, 'stock_qty': 0, 'category': 'Herramientas Electricas'},
    ]
