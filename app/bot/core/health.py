...
def check_redis() -> tuple[bool, str]:
    ...
    try:
        from app.bot.core.cache_manager import get_cache
        cache = get_cache()
...
def check_sentry() -> tuple[bool, str]:
    ...
    from app.bot.core.monitoring import get_monitoring
...
def register_health_checks(app):
    ...
    Usage:
        from app.bot.core.health import register_health_checks
