    ...
    def _load_bundles(self) -> Dict[str, Any]:
        ...
        try:
            with open(self.bundles_file, 'r', encoding='utf-8') as f:
                data = json.load(f)
                # Validate that we have at least some bundle data
                if data and (data.get("bundles_permanentes") or data.get("bundles_temporada")):
                    return data
                else:
        ...
        return {
            "bundles_permanentes": {
                "kit_taladrado": {
                    ...
                    "description": "Mechas + tarugos, todo para taladrar",
                    "active": True,
                    "discount_percent": 15,
                    "products": [
                        {"sku": , "quantity": 1},
                ...
                "gamer_basic": {
                    "name": "Pack Gamer Básico",
                    "description": "Start your game",
                    "active": True,
                    "discount_percent": 10,
                    "products": [
                        {"sku": "PS5-DIGITAL-WHT", "quantity": 1},
                        {"sku": "PS5-CTRL-WHT", "quantity": 2}
                    ]
                }
            }, 
            "bundles_temporada": {}
