...
class AuthManager:
    ...
    def __init__(self):
        ...
        if self.secret_key == 'change-me-in-production':
            logging.warning("⚠️  Using default JWT secret - CHANGE IN PRODUCTION!")
...
class UserDatabase:
    ...
    def __init__(self):
        self.users = {}
        # Create default admin user only when ADMIN_PASSWORD is explicitly configured.
        auth = get_auth_manager()
        ...
        if admin_password:
            ...
            logging.warning(
                "ADMIN_PASSWORD is empty; default admin user disabled until a password is configured."
            )
