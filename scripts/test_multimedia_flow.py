...
def test_audio_flow():
    ...
    with patch('bot_sales.connectors.whatsapp.WhatsAppConnector.download_media') as mock_download, \
        ...
        mock_transcribe.return_value = "Hola, tenés stock del Taladro Percutor 13mm?"
        mock_bot_process.return_value = "Sí, tengo stock del Taladro Percutor 13mm en negro. ¿Te interesa?"
...
def test_image_flow():
    ...
    with patch('bot_sales.connectors.whatsapp.WhatsAppConnector.download_media') as mock_download, \
        ...
        mock_analyze.return_value = {
            'model': 'Herramienta 14 Pro',
            'color': 'Deep Purple',
            'category': 'Herramienta'
        }
        mock_bot_process.return_value = "Veo que te interesa el Herramienta 14 Pro Deep Purple. Tengo 2 en stock."
