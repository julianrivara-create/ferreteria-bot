...
1. Serví `/Users/julian/Desktop/Cerrados/Ferreteria/tmp/training_demo_owner_final/snapshots` con un servidor estático:
   ```bash
   python3 -m http.server 8033 --directory "/Users/julian/Desktop/Cerrados/Ferreteria/tmp/training_demo_owner_final/snapshots"
   ```
...
- `02_sandbox_review.html`
  ...
  - ruta original: `/ops/ferreteria/training/sandbox?session_id=training:268af612205e44bca4500ab45ae23305&review_message_id=e05698ea7b804872a31adc5d90d0552f`
- `03_case_clarification.html`
  ...
  - ruta original: `/ops/ferreteria/training/cases/ae119272f85a47a2b7918dd63814e355`
- `04_case_regression.html`
  ...
  - ruta original: `/ops/ferreteria/training/cases/c1250f7a179848daaf4672fbabd18512`
- `05_suggestion_draft.html`
  - muestra: Borrador de corrección con contexto semántico de revisión y vista antes/después.
  - ruta original: `/ops/ferreteria/training/suggestions/c617137231df46449a1338df62bc8f7e`
- `06_suggestion_approved.html`
  - muestra: Corrección aprobada que muestra qué está listo para activarse a continuación.
  - ruta original: `/ops/ferreteria/training/suggestions/8738368e152140dc9ba2daec3ae70f3d`
- `07_cases_queue.html`
...
- perfil: `/Users/julian/Desktop/Cerrados/Ferreteria/tmp/training_demo_owner_final/workspace/profile.yaml`
- base de datos: `/Users/julian/Desktop/Cerrados/Ferreteria/tmp/training_demo_owner_final/workspace/ferreteria_training_demo.db`
