...
def run_demo():
    ...
    os.system('rm -f ferreteria.db events.log')

    demos = [
        {
            "title": "🎁 DEMO 1: Compra rápida (humana) + Reserva + Confirmación",
            "steps": [
                # Bot pregunta qué Herramienta -> respondemos.
                ...
                {"wait_for": [
                    r"¿Qué Herramienta estás buscando", 
                    r"¡Hola! Decime qué buscás", 
                    r"Buenas! 👋",
                    r"Hola, ¿en qué modelo estabas pensando"
                ], "input": "hola! busco una amoladora 115mm"},
        ...
        },
        {
            ...
            "steps": [
                {"wait_for": [
                    ...
                    r"Buenas! 👋",
                    r"Hola, ¿en qué modelo estabas pensando"
                ], "input": "hola, quiero un taladro percutor"},
                {"wait_for": [r"¿Cuál preferís\?"], "input": "256 black"},
                ...
                {"wait_for": [r"¿Qué Herramienta estás buscando|Decime modelo|¿Qu[eé] Herramienta|¿Qu[eé] modelo busc[aá]s"], "input": "ok, cambié: 17 pro max 512 desert"},
