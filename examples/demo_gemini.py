...
def main():
    ...
    # ========================================
    # ESCENARIO 1: Compra de Lijadora
    # ========================================
    simulate_conversation(
        bot, "demo_1",
        [
            "Hola, busco un Lijadora", 
            "El Lijadora Air 11 de 256GB azul",
            "Perfecto. Soy Ana, WhatsApp 1199887766",
            "CABA",
            "Transferencia",
            "Dale, confirmo la compra"
        ],
        "Compra de Lijadora Air - Gemini"
    )
    
    # ========================================
    # ESCENARIO 2: Nivel Laser 5 con consulta
    # ========================================
    simulate_conversation(
        bot, "demo_2",
        [
            "Buenas",
            "Qué Nivel Laser tenés?",
            "La PS5 disc blanca",
            "Sí. Diego 1177665544",
            "Retiro en local",
            "Efectivo",
        ...
        "Nivel Laser 5 - Búsqueda por categoría"
    )
    
    # ========================================
    # ESCENARIO 3: Destornillador a Bateria directo
    # ========================================
    simulate_conversation(
        bot, "demo_3",
        [
            "Hola!",
            "Destornillador a Bateria",
            "Dale, me los llevo. Laura 1188776655",
            "AMBA",
            "MercadoPago",
            "Sí"
        ],
        "Destornillador a Bateria - Compra rápida"
    )
    
    # ========================================
    # ESCENARIO 4: Sierra Circular con alternativas
    # ========================================
    simulate_conversation(
        bot, "demo_4",
        [
            "Hola",
            "Sierra Circular Pro 16 M3 Max 1TB Space Black",
            "Mostrame alternativas",
            "La Sierra Circular Pro 14 512",
            "Perfecto. Martín 1166554433",
            "Interior",
            "Tarjeta con cuotas",
            "Confirmo"
        ],
        "Sierra Circular - Con alternativas"
    )
    
    # ========================================
    # ESCENARIO 5: Herramienta + Derivación a humano
    # ========================================
    simulate_conversation(
        bot, "demo_5",
        [
            "Hola",
            "Amoladora 115mm Pro Max 1TB",
            "Necesito factura A y negociar el precio",
            "Claudia, empresa Tech SRL, 1155443322"
        ],
        "Herramienta - Derivación a humano (factura A)"
    )
    ...
    print(f"{C.GREY}1. ✅ Lijadora Air - Compra estándar{C.END}")
    print(f"{C.GREY}2. ✅ Nivel Laser 5 - Búsqueda por categoría{C.END}")
    print(f"{C.GREY}3. ✅ Destornillador a Bateria - Compra rápida{C.END}")
    print(f"{C.GREY}4. ✅ Sierra Circular - Con sugerencia de alternativas{C.END}")
    print(f"{C.GREY}5. ✅ Herramienta - Derivación a humano (factura A){C.END}")
